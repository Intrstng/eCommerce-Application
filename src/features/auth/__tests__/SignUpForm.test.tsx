...
describe('SignUpForm', () => {
    ...
    it('shows validation errors on invalid input', async () => {
        ...
        await waitFor(() => {
            expect(
                screen.getByText(
                    /First name must contain at least one character and not contain special characters or digits/i
                )
            ).toBeInTheDocument();
        });
        ...
        await waitFor(() => {
            expect(
                screen.getByText(
                    /Last name must contain at least one character and not contain special characters or digits/i
                )
            ).toBeInTheDocument();
        });
    });
